...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		var p = $.extend(true,{
			...
			_index : {},
			grouping : false,
			groupingView : {groupField:[],groupOrder:[], groupText:[],groupColumnShow:[],groupSummary:[], showSummaryOnHide: false, sortitems:[], sortnames:[], summary:[],summaryval:[], plusicon: 'ui-icon-circle-plus', minusicon: 'ui-icon-circle-minus', displayField: []},
			ignoreCase : false,
			cmTemplate : {},
			idPrefix : ""
		}, $.jgrid.defaults, pin || {});
		...
		setPager = function (pgid, tp){
			...
			$('input.ui-pg-input',"#"+pgcnt).keypress( function(e) {
				...
				if(key == 13) {
					...
					if (intNum( $(this).val(), 1) > ts.p.lastpage) {
		...
		imgs = "<span class='s-ico' style=''><span sort='asc' class='ui-grid-ico-sort ui-icon-asc"+iac+" ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-"+dir+"'></span>";
							...
							if(p.searchOnEnter) {
								...
								//$("input",thd).keypress(function(e){
									...
									if(key == 13){
										triggerToolbar();
										return false;
									}else if(key == 8 && this.value == ""){//BackSpace
